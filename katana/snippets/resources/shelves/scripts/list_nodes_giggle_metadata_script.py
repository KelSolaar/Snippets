...
snippets.libraries.utilities.single_shot_script_node(
    "/usr/people/thomas-ma/Developement/Snippets/katana/snippets/resources/recipes/list_nodes_giggle_metadata_Script_vLatest.katana",
    "list_nodes_giggle_metadata")
