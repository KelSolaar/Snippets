...
snippets.libraries.utilities.single_shot_script_node(
    "/usr/people/thomas-ma/Developement/Snippets/katana/snippets/resources/recipes/remove_nodes_names_trailing_numbers_Script_vLatest.katana",
    "remove_nodes_names_trailing_numbers")
