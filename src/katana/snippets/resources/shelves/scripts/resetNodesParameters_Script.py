...
snippets.libraries.utilities.singleShotScriptNode("/usr/people/thomas-ma/Developement/Snippets/src/katana/snippets/resources/recipes/resetNodesParameters_Script_vLatest.katana", "resetNodesParameters")
