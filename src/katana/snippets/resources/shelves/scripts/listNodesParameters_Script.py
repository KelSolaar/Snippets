...
snippets.libraries.utilities.singleShotScriptNode("/usr/people/thomas-ma/Developement/Snippets/src/katana/snippets/resources/recipes/listNodesParameters_Script_vLatest.katana", "listNodesParameters")
